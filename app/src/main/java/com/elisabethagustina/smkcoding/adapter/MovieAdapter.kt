...
import com.elisabethagustina.smkcoding.activity.DetailMovieActivity
...
// holder = mengikat, view = tampilan
class MovieAdapter (val list: List<ResultsItem?>?, val context: Context)
